...
load jas_in_nnMI_OR.dat
load jab_in_nnMI_OR.dat
load jba_in_nnMI_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_nnMI_OR);
size_jab=length(jab_in_nnMI_OR);
size_jba=length(jba_in_nnMI_OR);
...
Jas=jas_in_nnMI_OR(rnd_as(1:nr));
Jbs=jas_in_nnMI_OR(rnd_bs(1:nr));
Jab=jab_in_nnMI_OR(rnd_ab(1:nr));
Jba=jba_in_nnMI_OR(rnd_ba(1:nr));
...
nnMI_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];           
total_seg=sum(nnMI_OR_dataR.total_bistability)
...
nnMI_OR_dataR.data=data;
nnMI_OR_dataR.para_BS_all=para_BS_all;
nnMI_OR_dataR.para_BS_pck=para_BS_pck;
nnMI_OR_dataR.para_bis=para_bis;
nnMI_OR_dataR.para_iso=para_iso;
nnMI_OR_dataR.para_invis=para_inviso;
nnMI_OR_dataR.para_dni=para_dni;
nnMI_OR_dataR.para_nibi=para_nibi;
nnMI_OR_dataR.para_dbs=para_dbs;
nnMI_OR_dataR.para_mush=para_mush;
nnMI_OR_dataR.para_invmush=para_invmush;
nnMI_OR_dataR.para_iibi=para_iibi;
nnMI_OR_dataR.para_nim=para_nim;
nnMI_OR_dataR.para_mbs=para_mbs;
nnMI_OR_dataR.para_iim=para_iim;
nnMI_OR_dataR.para_nidbs=para_nidbs;
nnMI_OR_dataR.para_tbs=para_tbs;
nnMI_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
nnMI_OR_dataR.indx_bis=bispar;
nnMI_OR_dataR.indx_iso=isopar;
nnMI_OR_dataR.indx_invis=invisopar;
nnMI_OR_dataR.indx_dni=dnipar;
nnMI_OR_dataR.indx_nibi=nibipar;
nnMI_OR_dataR.indx_dbs=dbspar;
nnMI_OR_dataR.indx_mush=mushpar;
nnMI_OR_dataR.indx_invmush=invmushpar;
nnMI_OR_dataR.indx_iibi=iibipar;
nnMI_OR_dataR.indx_nim=nimpar;
nnMI_OR_dataR.indx_mbs=mbspar;
nnMI_OR_dataR.indx_iim=iimpar;
nnMI_OR_dataR.indx_nidbs=nidbspar;
nnMI_OR_dataR.indx_tbs=tbspar;
nnMI_OR_dataR.indx_iidbs=iidbspar;

save parscan_nnMI_OR_R1.mat nnMI_OR_dataR
