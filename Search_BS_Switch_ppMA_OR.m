...
load jas_in_ppMA_OR.dat
load jab_in_ppMA_OR.dat
load jba_in_ppMA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_ppMA_OR);
size_jab=length(jab_in_ppMA_OR);
size_jba=length(jba_in_ppMA_OR);
...
Jas=jas_in_ppMA_OR(rnd_as(1:nr));
Jbs=jas_in_ppMA_OR(rnd_bs(1:nr));
Jab=jab_in_ppMA_OR(rnd_ab(1:nr));
Jba=jba_in_ppMA_OR(rnd_ba(1:nr));
...
ppMA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];           
total_seg=sum(ppMA_OR_dataR.total_bistability)
...
ppMA_OR_dataR.data=data;
ppMA_OR_dataR.para_BS_all=para_BS_all;
ppMA_OR_dataR.para_BS_pck=para_BS_pck;
ppMA_OR_dataR.para_bis=para_bis;
ppMA_OR_dataR.para_iso=para_iso;
ppMA_OR_dataR.para_invis=para_inviso;
ppMA_OR_dataR.para_dni=para_dni;
ppMA_OR_dataR.para_nibi=para_nibi;
ppMA_OR_dataR.para_dbs=para_dbs;
ppMA_OR_dataR.para_mush=para_mush;
ppMA_OR_dataR.para_invmush=para_invmush;
ppMA_OR_dataR.para_iibi=para_iibi;
ppMA_OR_dataR.para_nim=para_nim;
ppMA_OR_dataR.para_mbs=para_mbs;
ppMA_OR_dataR.para_iim=para_iim;
ppMA_OR_dataR.para_nidbs=para_nidbs;
ppMA_OR_dataR.para_tbs=para_tbs;
ppMA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
ppMA_OR_dataR.indx_bis=bispar;
ppMA_OR_dataR.indx_iso=isopar;
ppMA_OR_dataR.indx_invis=invisopar;
ppMA_OR_dataR.indx_dni=dnipar;
ppMA_OR_dataR.indx_nibi=nibipar;
ppMA_OR_dataR.indx_dbs=dbspar;
ppMA_OR_dataR.indx_mush=mushpar;
ppMA_OR_dataR.indx_invmush=invmushpar;
ppMA_OR_dataR.indx_iibi=iibipar;
ppMA_OR_dataR.indx_nim=nimpar;
ppMA_OR_dataR.indx_mbs=mbspar;
ppMA_OR_dataR.indx_iim=iimpar;
ppMA_OR_dataR.indx_nidbs=nidbspar;
ppMA_OR_dataR.indx_tbs=tbspar;
ppMA_OR_dataR.indx_iidbs=iidbspar;

save parscan_ppMA_OR_R1.mat ppMA_OR_dataR
