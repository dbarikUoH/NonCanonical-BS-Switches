...
load jas_in_ppMI_OR.dat
load jab_in_ppMI_OR.dat
load jba_in_ppMI_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_ppMI_OR);
size_jab=length(jab_in_ppMI_OR);
size_jba=length(jba_in_ppMI_OR);
...
Jas=jas_in_ppMI_OR(rnd_as(1:nr));
Jbs=jas_in_ppMI_OR(rnd_bs(1:nr));
Jab=jab_in_ppMI_OR(rnd_ab(1:nr));
Jba=jba_in_ppMI_OR(rnd_ba(1:nr));
...
%         plot(abs(xpeak));
        ...
        MxMn=[mxDf mnDf];
        jmpN=length(MxMn);  % number of mupms
...
ppMI_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
...
ppMI_OR_dataR.data=data;
ppMI_OR_dataR.para_BS_all=para_BS_all;
ppMI_OR_dataR.para_BS_pck=para_BS_pck;
ppMI_OR_dataR.para_bis=para_bis;
ppMI_OR_dataR.para_iso=para_iso;
ppMI_OR_dataR.para_invis=para_inviso;
ppMI_OR_dataR.para_dni=para_dni;
ppMI_OR_dataR.para_nibi=para_nibi;
ppMI_OR_dataR.para_dbs=para_dbs;
ppMI_OR_dataR.para_mush=para_mush;
ppMI_OR_dataR.para_invmush=para_invmush;
ppMI_OR_dataR.para_iibi=para_iibi;
ppMI_OR_dataR.para_nim=para_nim;
ppMI_OR_dataR.para_mbs=para_mbs;
ppMI_OR_dataR.para_iim=para_iim;
ppMI_OR_dataR.para_nidbs=para_nidbs;
ppMI_OR_dataR.para_tbs=para_tbs;
ppMI_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
ppMI_OR_dataR.indx_bis=bispar;
ppMI_OR_dataR.indx_iso=isopar;
ppMI_OR_dataR.indx_invis=invisopar;
ppMI_OR_dataR.indx_dni=dnipar;
ppMI_OR_dataR.indx_nibi=nibipar;
ppMI_OR_dataR.indx_dbs=dbspar;
ppMI_OR_dataR.indx_mush=mushpar;
ppMI_OR_dataR.indx_invmush=invmushpar;
ppMI_OR_dataR.indx_iibi=iibipar;
ppMI_OR_dataR.indx_nim=nimpar;
ppMI_OR_dataR.indx_mbs=mbspar;
ppMI_OR_dataR.indx_iim=iimpar;
ppMI_OR_dataR.indx_nidbs=nidbspar;
ppMI_OR_dataR.indx_tbs=tbspar;
ppMI_OR_dataR.indx_iidbs=iidbspar;

save parscan_ppMI_OR_R1.mat ppMI_OR_dataR
