...
load jas_in_pnMISA_OR.dat
load jab_in_pnMISA_OR.dat
load jba_in_pnMISA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_pnMISA_OR);
size_jab=length(jab_in_pnMISA_OR);
size_jba=length(jba_in_pnMISA_OR);
...
Jas=jas_in_pnMISA_OR(rnd_as(1:nr));
Jbs=jas_in_pnMISA_OR(rnd_bs(1:nr));
Jab=jab_in_pnMISA_OR(rnd_ab(1:nr));
Jba=jba_in_pnMISA_OR(rnd_ba(1:nr));
Jbb=jba_in_pnMISA_OR(rnd_bb(1:nr));
...
pnMISA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(pnMISA_OR_dataR.total_bistability)
...
pnMISASA_OR_dataR.data=data;
pnMISA_OR_dataR.para_BS_all=para_BS_all;
pnMISA_OR_dataR.para_BS_pck=para_BS_pck;
pnMISA_OR_dataR.para_bis=para_bis;
pnMISA_OR_dataR.para_iso=para_iso;
pnMISA_OR_dataR.para_invis=para_inviso;
pnMISA_OR_dataR.para_dni=para_dni;
pnMISA_OR_dataR.para_nibi=para_nibi;
pnMISA_OR_dataR.para_dbs=para_dbs;
pnMISA_OR_dataR.para_mush=para_mush;
pnMISA_OR_dataR.para_invmush=para_invmush;
pnMISA_OR_dataR.para_iibi=para_iibi;
pnMISA_OR_dataR.para_nim=para_nim;
pnMISA_OR_dataR.para_mbs=para_mbs;
pnMISA_OR_dataR.para_iim=para_iim;
pnMISA_OR_dataR.para_nidbs=para_nidbs;
pnMISA_OR_dataR.para_tbs=para_tbs;
pnMISA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
pnMISA_OR_dataR.indx_bis=bispar;
pnMISA_OR_dataR.indx_iso=isopar;
pnMISA_OR_dataR.indx_invis=invisopar;
pnMISA_OR_dataR.indx_dni=dnipar;
pnMISA_OR_dataR.indx_nibi=nibipar;
pnMISA_OR_dataR.indx_dbs=dbspar;
pnMISA_OR_dataR.indx_mush=mushpar;
pnMISA_OR_dataR.indx_invmush=invmushpar;
pnMISA_OR_dataR.indx_iibi=iibipar;
pnMISA_OR_dataR.indx_nim=nimpar;
pnMISA_OR_dataR.indx_mbs=mbspar;
pnMISA_OR_dataR.indx_iim=iimpar;
pnMISA_OR_dataR.indx_nidbs=nidbspar;
pnMISA_OR_dataR.indx_tbs=tbspar;
pnMISA_OR_dataR.indx_iidbs=iidbspar;

save parscan_pnMISA_OR_R1.mat pnMISA_OR_dataR
