...
load jas_in_nnMISA_OR.dat
load jab_in_nnMISA_OR.dat
load jba_in_nnMISA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_nnMISA_OR);
size_jab=length(jab_in_nnMISA_OR);
size_jba=length(jba_in_nnMISA_OR);
...
Jas=jas_in_nnMISA_OR(rnd_as(1:nr));
Jbs=jas_in_nnMISA_OR(rnd_bs(1:nr));
Jab=jab_in_nnMISA_OR(rnd_ab(1:nr));
Jba=jba_in_nnMISA_OR(rnd_ba(1:nr));
Jbb=jba_in_nnMISA_OR(rnd_bb(1:nr));
...
nnMISA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(nnMISA_OR_dataR.total_bistability)
...
nnMISASA_OR_dataR.data=data;
nnMISA_OR_dataR.para_BS_all=para_BS_all;
nnMISA_OR_dataR.para_BS_pck=para_BS_pck;
nnMISA_OR_dataR.para_bis=para_bis;
nnMISA_OR_dataR.para_iso=para_iso;
nnMISA_OR_dataR.para_invis=para_inviso;
nnMISA_OR_dataR.para_dni=para_dni;
nnMISA_OR_dataR.para_nibi=para_nibi;
nnMISA_OR_dataR.para_dbs=para_dbs;
nnMISA_OR_dataR.para_mush=para_mush;
nnMISA_OR_dataR.para_invmush=para_invmush;
nnMISA_OR_dataR.para_iibi=para_iibi;
nnMISA_OR_dataR.para_nim=para_nim;
nnMISA_OR_dataR.para_mbs=para_mbs;
nnMISA_OR_dataR.para_iim=para_iim;
nnMISA_OR_dataR.para_nidbs=para_nidbs;
nnMISA_OR_dataR.para_tbs=para_tbs;
nnMISA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
nnMISA_OR_dataR.indx_bis=bispar;
nnMISA_OR_dataR.indx_iso=isopar;
nnMISA_OR_dataR.indx_invis=invisopar;
nnMISA_OR_dataR.indx_dni=dnipar;
nnMISA_OR_dataR.indx_nibi=nibipar;
nnMISA_OR_dataR.indx_dbs=dbspar;
nnMISA_OR_dataR.indx_mush=mushpar;
nnMISA_OR_dataR.indx_invmush=invmushpar;
nnMISA_OR_dataR.indx_iibi=iibipar;
nnMISA_OR_dataR.indx_nim=nimpar;
nnMISA_OR_dataR.indx_mbs=mbspar;
nnMISA_OR_dataR.indx_iim=iimpar;
nnMISA_OR_dataR.indx_nidbs=nidbspar;
nnMISA_OR_dataR.indx_tbs=tbspar;
nnMISA_OR_dataR.indx_iidbs=iidbspar;

save parscan_nnMISA_OR_R1.mat nnMISA_OR_dataR
