...
load jas_in_pnMASA_OR.dat
load jab_in_pnMASA_OR.dat
load jba_in_pnMASA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_pnMASA_OR);
size_jab=length(jab_in_pnMASA_OR);
size_jba=length(jba_in_pnMASA_OR);
...
Jas=jas_in_pnMASA_OR(rnd_as(1:nr));
Jbs=jas_in_pnMASA_OR(rnd_bs(1:nr));
Jab=jab_in_pnMASA_OR(rnd_ab(1:nr));
Jba=jba_in_pnMASA_OR(rnd_ba(1:nr));
Jbb=jba_in_pnMASA_OR(rnd_bb(1:nr));
...
pnMASA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(pnMASA_OR_dataR.total_bistability)
...
pnMASASA_OR_dataR.data=data;
pnMASA_OR_dataR.para_BS_all=para_BS_all;
pnMASA_OR_dataR.para_BS_pck=para_BS_pck;
pnMASA_OR_dataR.para_bis=para_bis;
pnMASA_OR_dataR.para_iso=para_iso;
pnMASA_OR_dataR.para_invis=para_inviso;
pnMASA_OR_dataR.para_dni=para_dni;
pnMASA_OR_dataR.para_nibi=para_nibi;
pnMASA_OR_dataR.para_dbs=para_dbs;
pnMASA_OR_dataR.para_mush=para_mush;
pnMASA_OR_dataR.para_invmush=para_invmush;
pnMASA_OR_dataR.para_iibi=para_iibi;
pnMASA_OR_dataR.para_nim=para_nim;
pnMASA_OR_dataR.para_mbs=para_mbs;
pnMASA_OR_dataR.para_iim=para_iim;
pnMASA_OR_dataR.para_nidbs=para_nidbs;
pnMASA_OR_dataR.para_tbs=para_tbs;
pnMASA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
pnMASA_OR_dataR.indx_bis=bispar;
pnMASA_OR_dataR.indx_iso=isopar;
pnMASA_OR_dataR.indx_invis=invisopar;
pnMASA_OR_dataR.indx_dni=dnipar;
pnMASA_OR_dataR.indx_nibi=nibipar;
pnMASA_OR_dataR.indx_dbs=dbspar;
pnMASA_OR_dataR.indx_mush=mushpar;
pnMASA_OR_dataR.indx_invmush=invmushpar;
pnMASA_OR_dataR.indx_iibi=iibipar;
pnMASA_OR_dataR.indx_nim=nimpar;
pnMASA_OR_dataR.indx_mbs=mbspar;
pnMASA_OR_dataR.indx_iim=iimpar;
pnMASA_OR_dataR.indx_nidbs=nidbspar;
pnMASA_OR_dataR.indx_tbs=tbspar;
pnMASA_OR_dataR.indx_iidbs=iidbspar;

save parscan_pnMASA_OR_R1.mat pnMASA_OR_dataR
