...
load jas_in_pnMA_OR.dat
load jab_in_pnMA_OR.dat
load jba_in_pnMA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_pnMA_OR);
size_jab=length(jab_in_pnMA_OR);
size_jba=length(jba_in_pnMA_OR);
...
Jas=jas_in_pnMA_OR(rnd_as(1:nr));
Jbs=jas_in_pnMA_OR(rnd_bs(1:nr));
Jab=jab_in_pnMA_OR(rnd_ab(1:nr));
Jba=jba_in_pnMA_OR(rnd_ba(1:nr));
...
pnMA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];           
total_seg=sum(pnMA_OR_dataR.total_bistability)
...
pnMA_OR_dataR.data=data;
pnMA_OR_dataR.para_BS_all=para_BS_all;
pnMA_OR_dataR.para_BS_pck=para_BS_pck;
pnMA_OR_dataR.para_bis=para_bis;
pnMA_OR_dataR.para_iso=para_iso;
pnMA_OR_dataR.para_invis=para_inviso;
pnMA_OR_dataR.para_dni=para_dni;
pnMA_OR_dataR.para_nibi=para_nibi;
pnMA_OR_dataR.para_dbs=para_dbs;
pnMA_OR_dataR.para_mush=para_mush;
pnMA_OR_dataR.para_invmush=para_invmush;
pnMA_OR_dataR.para_iibi=para_iibi;
pnMA_OR_dataR.para_nim=para_nim;
pnMA_OR_dataR.para_mbs=para_mbs;
pnMA_OR_dataR.para_iim=para_iim;
pnMA_OR_dataR.para_nidbs=para_nidbs;
pnMA_OR_dataR.para_tbs=para_tbs;
pnMA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
pnMA_OR_dataR.indx_bis=bispar;
pnMA_OR_dataR.indx_iso=isopar;
pnMA_OR_dataR.indx_invis=invisopar;
pnMA_OR_dataR.indx_dni=dnipar;
pnMA_OR_dataR.indx_nibi=nibipar;
pnMA_OR_dataR.indx_dbs=dbspar;
pnMA_OR_dataR.indx_mush=mushpar;
pnMA_OR_dataR.indx_invmush=invmushpar;
pnMA_OR_dataR.indx_iibi=iibipar;
pnMA_OR_dataR.indx_nim=nimpar;
pnMA_OR_dataR.indx_mbs=mbspar;
pnMA_OR_dataR.indx_iim=iimpar;
pnMA_OR_dataR.indx_nidbs=nidbspar;
pnMA_OR_dataR.indx_tbs=tbspar;
pnMA_OR_dataR.indx_iidbs=iidbspar;

save parscan_pnMA_OR_R1.mat pnMA_OR_dataR
