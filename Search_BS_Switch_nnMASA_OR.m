...
load jas_in_nnMASA_OR.dat
load jab_in_nnMASA_OR.dat
load jba_in_nnMASA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_nnMASA_OR);
size_jab=length(jab_in_nnMASA_OR);
size_jba=length(jba_in_nnMASA_OR);
...
Jas=jas_in_nnMASA_OR(rnd_as(1:nr));
Jbs=jas_in_nnMASA_OR(rnd_bs(1:nr));
Jab=jab_in_nnMASA_OR(rnd_ab(1:nr));
Jba=jba_in_nnMASA_OR(rnd_ba(1:nr));
Jbb=jba_in_nnMASA_OR(rnd_bb(1:nr));
...
nnMASA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(nnMASA_OR_dataR.total_bistability)
...
nnMASASA_OR_dataR.data=data;
nnMASA_OR_dataR.para_BS_all=para_BS_all;
nnMASA_OR_dataR.para_BS_pck=para_BS_pck;
nnMASA_OR_dataR.para_bis=para_bis;
nnMASA_OR_dataR.para_iso=para_iso;
nnMASA_OR_dataR.para_invis=para_inviso;
nnMASA_OR_dataR.para_dni=para_dni;
nnMASA_OR_dataR.para_nibi=para_nibi;
nnMASA_OR_dataR.para_dbs=para_dbs;
nnMASA_OR_dataR.para_mush=para_mush;
nnMASA_OR_dataR.para_invmush=para_invmush;
nnMASA_OR_dataR.para_iibi=para_iibi;
nnMASA_OR_dataR.para_nim=para_nim;
nnMASA_OR_dataR.para_mbs=para_mbs;
nnMASA_OR_dataR.para_iim=para_iim;
nnMASA_OR_dataR.para_nidbs=para_nidbs;
nnMASA_OR_dataR.para_tbs=para_tbs;
nnMASA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
nnMASA_OR_dataR.indx_bis=bispar;
nnMASA_OR_dataR.indx_iso=isopar;
nnMASA_OR_dataR.indx_invis=invisopar;
nnMASA_OR_dataR.indx_dni=dnipar;
nnMASA_OR_dataR.indx_nibi=nibipar;
nnMASA_OR_dataR.indx_dbs=dbspar;
nnMASA_OR_dataR.indx_mush=mushpar;
nnMASA_OR_dataR.indx_invmush=invmushpar;
nnMASA_OR_dataR.indx_iibi=iibipar;
nnMASA_OR_dataR.indx_nim=nimpar;
nnMASA_OR_dataR.indx_mbs=mbspar;
nnMASA_OR_dataR.indx_iim=iimpar;
nnMASA_OR_dataR.indx_nidbs=nidbspar;
nnMASA_OR_dataR.indx_tbs=tbspar;
nnMASA_OR_dataR.indx_iidbs=iidbspar;

save parscan_nnMASA_OR_R1.mat nnMASA_OR_dataR
