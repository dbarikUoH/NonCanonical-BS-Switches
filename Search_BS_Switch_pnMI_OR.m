...
load jas_in_pnMI_OR.dat
load jab_in_pnMI_OR.dat
load jba_in_pnMI_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_pnMI_OR);
size_jab=length(jab_in_pnMI_OR);
size_jba=length(jba_in_pnMI_OR);
...
Jas=jas_in_pnMI_OR(rnd_as(1:nr));
Jbs=jas_in_pnMI_OR(rnd_bs(1:nr));
Jab=jab_in_pnMI_OR(rnd_ab(1:nr));
Jba=jba_in_pnMI_OR(rnd_ba(1:nr));
...
pnMI_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];           
total_seg=sum(pnMI_OR_dataR.total_bistability)
...
pnMI_OR_dataR.data=data;
pnMI_OR_dataR.para_BS_all=para_BS_all;
pnMI_OR_dataR.para_BS_pck=para_BS_pck;
pnMI_OR_dataR.para_bis=para_bis;
pnMI_OR_dataR.para_iso=para_iso;
pnMI_OR_dataR.para_invis=para_inviso;
pnMI_OR_dataR.para_dni=para_dni;
pnMI_OR_dataR.para_nibi=para_nibi;
pnMI_OR_dataR.para_dbs=para_dbs;
pnMI_OR_dataR.para_mush=para_mush;
pnMI_OR_dataR.para_invmush=para_invmush;
pnMI_OR_dataR.para_iibi=para_iibi;
pnMI_OR_dataR.para_nim=para_nim;
pnMI_OR_dataR.para_mbs=para_mbs;
pnMI_OR_dataR.para_iim=para_iim;
pnMI_OR_dataR.para_nidbs=para_nidbs;
pnMI_OR_dataR.para_tbs=para_tbs;
pnMI_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
pnMI_OR_dataR.indx_bis=bispar;
pnMI_OR_dataR.indx_iso=isopar;
pnMI_OR_dataR.indx_invis=invisopar;
pnMI_OR_dataR.indx_dni=dnipar;
pnMI_OR_dataR.indx_nibi=nibipar;
pnMI_OR_dataR.indx_dbs=dbspar;
pnMI_OR_dataR.indx_mush=mushpar;
pnMI_OR_dataR.indx_invmush=invmushpar;
pnMI_OR_dataR.indx_iibi=iibipar;
pnMI_OR_dataR.indx_nim=nimpar;
pnMI_OR_dataR.indx_mbs=mbspar;
pnMI_OR_dataR.indx_iim=iimpar;
pnMI_OR_dataR.indx_nidbs=nidbspar;
pnMI_OR_dataR.indx_tbs=tbspar;
pnMI_OR_dataR.indx_iidbs=iidbspar;

save parscan_pnMI_OR_R1.mat pnMI_OR_dataR
