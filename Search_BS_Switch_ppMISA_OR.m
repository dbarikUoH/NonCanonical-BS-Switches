...
ppMISA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
...
ppMISASA_OR_dataR.data=data;
ppMISA_OR_dataR.para_BS_all=para_BS_all;
ppMISA_OR_dataR.para_BS_pck=para_BS_pck;
ppMISA_OR_dataR.para_bis=para_bis;
ppMISA_OR_dataR.para_iso=para_iso;
ppMISA_OR_dataR.para_invis=para_inviso;
ppMISA_OR_dataR.para_dni=para_dni;
ppMISA_OR_dataR.para_nibi=para_nibi;
ppMISA_OR_dataR.para_dbs=para_dbs;
ppMISA_OR_dataR.para_mush=para_mush;
ppMISA_OR_dataR.para_invmush=para_invmush;
ppMISA_OR_dataR.para_iibi=para_iibi;
ppMISA_OR_dataR.para_nim=para_nim;
ppMISA_OR_dataR.para_mbs=para_mbs;
ppMISA_OR_dataR.para_iim=para_iim;
ppMISA_OR_dataR.para_nidbs=para_nidbs;
ppMISA_OR_dataR.para_tbs=para_tbs;
ppMISA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
ppMISA_OR_dataR.indx_bis=bispar;
ppMISA_OR_dataR.indx_iso=isopar;
ppMISA_OR_dataR.indx_invis=invisopar;
ppMISA_OR_dataR.indx_dni=dnipar;
ppMISA_OR_dataR.indx_nibi=nibipar;
ppMISA_OR_dataR.indx_dbs=dbspar;
ppMISA_OR_dataR.indx_mush=mushpar;
ppMISA_OR_dataR.indx_invmush=invmushpar;
ppMISA_OR_dataR.indx_iibi=iibipar;
ppMISA_OR_dataR.indx_nim=nimpar;
ppMISA_OR_dataR.indx_mbs=mbspar;
ppMISA_OR_dataR.indx_iim=iimpar;
ppMISA_OR_dataR.indx_nidbs=nidbspar;
ppMISA_OR_dataR.indx_tbs=tbspar;
ppMISA_OR_dataR.indx_iidbs=iidbspar;

save parscan_ppMISA_OR_R1.mat ppMISA_OR_dataR
