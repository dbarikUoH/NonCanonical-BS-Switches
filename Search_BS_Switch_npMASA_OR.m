...
load jas_in_npMASA_OR.dat
load jab_in_npMASA_OR.dat
load jba_in_npMASA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_npMASA_OR);
size_jab=length(jab_in_npMASA_OR);
size_jba=length(jba_in_npMASA_OR);
...
Jas=jas_in_npMASA_OR(rnd_as(1:nr));
Jbs=jas_in_npMASA_OR(rnd_bs(1:nr));
Jab=jab_in_npMASA_OR(rnd_ab(1:nr));
Jba=jba_in_npMASA_OR(rnd_ba(1:nr));
Jbb=jba_in_npMASA_OR(rnd_bb(1:nr));
...
npMASA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(npMASA_OR_dataR.total_bistability)
...
npMASASA_OR_dataR.data=data;
npMASA_OR_dataR.para_BS_all=para_BS_all;
npMASA_OR_dataR.para_BS_pck=para_BS_pck;
npMASA_OR_dataR.para_bis=para_bis;
npMASA_OR_dataR.para_iso=para_iso;
npMASA_OR_dataR.para_invis=para_inviso;
npMASA_OR_dataR.para_dni=para_dni;
npMASA_OR_dataR.para_nibi=para_nibi;
npMASA_OR_dataR.para_dbs=para_dbs;
npMASA_OR_dataR.para_mush=para_mush;
npMASA_OR_dataR.para_invmush=para_invmush;
npMASA_OR_dataR.para_iibi=para_iibi;
npMASA_OR_dataR.para_nim=para_nim;
npMASA_OR_dataR.para_mbs=para_mbs;
npMASA_OR_dataR.para_iim=para_iim;
npMASA_OR_dataR.para_nidbs=para_nidbs;
npMASA_OR_dataR.para_tbs=para_tbs;
npMASA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
npMASA_OR_dataR.indx_bis=bispar;
npMASA_OR_dataR.indx_iso=isopar;
npMASA_OR_dataR.indx_invis=invisopar;
npMASA_OR_dataR.indx_dni=dnipar;
npMASA_OR_dataR.indx_nibi=nibipar;
npMASA_OR_dataR.indx_dbs=dbspar;
npMASA_OR_dataR.indx_mush=mushpar;
npMASA_OR_dataR.indx_invmush=invmushpar;
npMASA_OR_dataR.indx_iibi=iibipar;
npMASA_OR_dataR.indx_nim=nimpar;
npMASA_OR_dataR.indx_mbs=mbspar;
npMASA_OR_dataR.indx_iim=iimpar;
npMASA_OR_dataR.indx_nidbs=nidbspar;
npMASA_OR_dataR.indx_tbs=tbspar;
npMASA_OR_dataR.indx_iidbs=iidbspar;

save parscan_npMASA_OR_R1.mat npMASA_OR_dataR
