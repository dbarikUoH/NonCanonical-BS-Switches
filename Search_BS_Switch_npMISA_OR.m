...
load jas_in_npMISA_OR.dat
load jab_in_npMISA_OR.dat
load jba_in_npMISA_OR.dat

% Sample size of parameter combinations
nr=50000;                    

size_jas=length(jas_in_npMISA_OR);
size_jab=length(jab_in_npMISA_OR);
size_jba=length(jba_in_npMISA_OR);
...
Jas=jas_in_npMISA_OR(rnd_as(1:nr));
Jbs=jas_in_npMISA_OR(rnd_bs(1:nr));
Jab=jab_in_npMISA_OR(rnd_ab(1:nr));
Jba=jba_in_npMISA_OR(rnd_ba(1:nr));
Jbb=jba_in_npMISA_OR(rnd_bb(1:nr));
...
npMISA_OR_dataR.total_bistability=[tot_bis tot_iso tot_inviso tot_dni tot_nibi ...
    tot_dbs tot_mush tot_invmush tot_iibi tot_nim tot_mbs tot_iim tot_nidbs ...
      tot_tbs tot_iidbs];
total_seg=sum(npMISA_OR_dataR.total_bistability)
...
npMISASA_OR_dataR.data=data;
npMISA_OR_dataR.para_BS_all=para_BS_all;
npMISA_OR_dataR.para_BS_pck=para_BS_pck;
npMISA_OR_dataR.para_bis=para_bis;
npMISA_OR_dataR.para_iso=para_iso;
npMISA_OR_dataR.para_invis=para_inviso;
npMISA_OR_dataR.para_dni=para_dni;
npMISA_OR_dataR.para_nibi=para_nibi;
npMISA_OR_dataR.para_dbs=para_dbs;
npMISA_OR_dataR.para_mush=para_mush;
npMISA_OR_dataR.para_invmush=para_invmush;
npMISA_OR_dataR.para_iibi=para_iibi;
npMISA_OR_dataR.para_nim=para_nim;
npMISA_OR_dataR.para_mbs=para_mbs;
npMISA_OR_dataR.para_iim=para_iim;
npMISA_OR_dataR.para_nidbs=para_nidbs;
npMISA_OR_dataR.para_tbs=para_tbs;
npMISA_OR_dataR.para_iidbs=para_iidbs;

% storing of index of seggregated parameters
npMISA_OR_dataR.indx_bis=bispar;
npMISA_OR_dataR.indx_iso=isopar;
npMISA_OR_dataR.indx_invis=invisopar;
npMISA_OR_dataR.indx_dni=dnipar;
npMISA_OR_dataR.indx_nibi=nibipar;
npMISA_OR_dataR.indx_dbs=dbspar;
npMISA_OR_dataR.indx_mush=mushpar;
npMISA_OR_dataR.indx_invmush=invmushpar;
npMISA_OR_dataR.indx_iibi=iibipar;
npMISA_OR_dataR.indx_nim=nimpar;
npMISA_OR_dataR.indx_mbs=mbspar;
npMISA_OR_dataR.indx_iim=iimpar;
npMISA_OR_dataR.indx_nidbs=nidbspar;
npMISA_OR_dataR.indx_tbs=tbspar;
npMISA_OR_dataR.indx_iidbs=iidbspar;

save parscan_npMISA_OR_R1.mat npMISA_OR_dataR
